  ...
  protected render() {
    return html`
      ...
      <section class="article-section scrollspy-target" id="habit-visualization">
        ...
        <p>If you're a developer we hope you'll join us for a <a href="/hack">developer event</a> and/or check out our <a href="https://github.com/projectclarify/pcml" target="_blank">codebase</a> on GitHub.</p>
