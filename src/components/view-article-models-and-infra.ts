...
@customElement('view-article-models-and-infra')
export class ViewArticleModelsAndInfra extends connect(store)(PageViewElement) {
  ...
  protected render() {
    return html`
      ...
      <section class="article-hero">
        ...
        <p class="article-hero-heading">Learn about the technologies we use to do our research</p>
        <p class="article-hero-subheading">We use a modern stack of technologies for deep learning research and production</p>
      ...
      <section class="article-section scrollspy-target" id="ml-methods">
        <p class="article-section-pre-title">ML methods</p>
        <h2 class="article-section-title">We use a mixture of standard and emerging deep learning methods</h2>
        <p>Our research focus is on understanding emotional and cognitive states of people from rich time-series modalities like video, audio, and EEG as well as various other sensor types. The foundation of this program is in the application of conventional video labeling methods to predict emotion labels from short clips of video. On this foundation we are experimenting with the application of more modern self-supervised learning techniques to extend beyond the limitations entailed in expert-assigned state labels.</p>

        <table class="article-figure-legend-table">

        <tr><td><a href="https://en.wikipedia.org/wiki/Deep_learning" target="_blank"><b>Deep neural networks: </b></a>Our machine learning methods center primarily on the use of modern <a href="https://en.wikipedia.org/wiki/Deep_learning" target="_blank">deep neural networks</a> which can automate the process of identifying relevant features and modeling hierarchical and dynamical relationships among them.</td></tr>
        <tr><td><a href="https://en.wikipedia.org/wiki/Convolutional_neural_network" target="_blank"><b>Convolutional DNNs: </b></a>We use <a href="https://en.wikipedia.org/wiki/Convolutional_neural_network" target="_blank">cDNNs</a> as the first perceptual layer of our models including convolutions through both space and time. Our research is built on the foundation of standard cDNN (incl. crowd-sourced) label prediction from temporal (frame) sequences.</td></tr>
        <tr><td><b>Diverse augmentation: </b>We employ diverse forms of <a href="http://cs231n.stanford.edu/reports/2017/pdfs/300.pdf" target="_blank">data</a> <a href="https://journalofbigdata.springeropen.com/articles/10.1186/s40537-019-0197-0" target="_blank">augmentation</a> to help guide our models to learn useful representations (e.g. black patch augmentation of videos encouraging learning of redundant visual-temporal features).</td></tr>
        <tr><td><b>Modality correspondence: </b>We use <a href="https://arxiv.org/abs/1705.08168" target="_blank">modality correspondence methods</a> to supplement expensive, low-quality, or non-available labels by leveraging co-occurrence as a supervisory signal.</td></tr>
