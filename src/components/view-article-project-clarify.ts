  ...
  protected render() {
    return html`
      ...
      <section class="article-section scrollspy-target" id="trial-platform">
        ...
        <p>If you’re a developer you may want to continue reading about the trial platform in our <a href="/models-and-infra">Technical Discussion</a> section, read about our <a href="/hack">developer events</a>, and/or check out our machine learning research <a href="https://github.com/projectclarify/pcml" target="_blank">codebase</a> on GitHub.</p>
