...
This turned out a little rough, needs some re-thinking given we're going to have many variations
on a similar thing.
        ...
        <div class="session-step-container">
            ...
            <div class="session-step-inner">
                ...
                <div class="session-step-center-middle">
                  ...
                  <div class="session-step-description">Let's do a quick check-in before your project session.</div>
  ...
  renderSessionLeftMiddle(){
    return html`
        <div class="session-step-center-middle">
            ...
            <div class="session-step-title">Project Session</div>
        ...
        <div class="session-step-container">
            ...
            <div class="session-step-inner">
                ...
                <div class="session-step-center-middle">
                  ...
                  <div class="session-step-description">Let's do a quick check-in to conclude your project session.</div>
